...
// print source location
        ...
        public:
            ...
            void format(const details::log_msg &msg, const std::tm &, memory_buf_t &dest) override {
                ...
                size_t text_size =
                        padinfo_.enabled() ? std::char_traits<char>::length(msg.source.filename) +
                                             fmt_helper::count_digits(msg.source.line) + 1 : 0;
...
// pattern: [%Y-%m-%d %H:%M:%S.%e] [%n] [%l] %v
    ...
    SPDLOG_INLINE pattern_formatter::pattern_formatter(std::string pattern, pattern_time_type time_type,
                                                       std::string eol)
